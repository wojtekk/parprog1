...
class ListsSuite extends FunSuite {
  ...
  test("sum of a few numbers with negative numbers") {
    assert(sum(List(3, -7)) === -4)
  }

  test("sum of a few numbers with zero") {
    assert(sum(List(3, 7, 2, 0)) === 12)
  }

  test("sum of a few numbers with repeated") {
    assert(sum(List(3, 7, 2, 0, 14, 7, 3)) === 36)
  }
  ...
  test("max of a few numbers with zero") {
    assert(max(List(3, 7, 2, 0)) === 7)
  }

  test("max of a few numbers with repeated") {
    assert(max(List(3, 7, 2, 0, 14, 7, 3)) === 14)
  }
